...
export const Footer = () => {
  return (
    ...
    <div  className='mt-10 bg-sky-700' id='rowfooter1'>
      <div className='grid grid-cols-6 mt-10 ml-10 mr-10  xs:grid-cols-2 xs:bg-red-800 ' id='rowf1'>
         ...
         <div className='mt-10 mb-10 xs:ml-10'>
        ...
        <h2  className='text-xs text-stone-400'>Become affiliate</h2>
         ...
         <div className='mt-10 mb-10  xs:ml-10'>   <h2  className='text-2xl text-stone-400 '>Coorporate corner</h2>
         <h2  className='text-xs text-stone-400'>Coorporate</h2> 
         <h2  className='text-xs text-stone-400'>Benifits of Homepathy</h2>
